...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Majors</li>
        </ol>
        <h6 class="font-weight-bolder mb-0">Majors</h6>
    </nav>
                    ...
                    <div class="d-lg-flex">
                        ...
                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                            <div class="ms-auto my-auto">
                                <a href="/majors-create" class="btn bg-gradient-primary btn-sm mb-0">+&nbsp;
                                    New majors
                                </a>
                            </div>
                        </div>
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        window.location = "/majors-destroy/" + id + "";
