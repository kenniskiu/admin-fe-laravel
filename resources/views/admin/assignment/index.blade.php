                    ...
                    <div class="d-lg-flex">
                        ...
                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                            <div class="ms-auto my-auto">
                                <a href="/assignment-create" class="btn bg-gradient-primary btn-sm mb-0">+&nbsp;
                                    New Assignments
                                </a>
                            </div>
                        </div>
                    ...
                    <table class="table table-flus datatable-basic">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Session ID
                                </th>
                            ...
                            @foreach ($data as $x)
                                <tr>
                                    ...
                                    <td class="text-sm col-lg-2">
                                        <a href="/assignment-edit/{{ $x->id }}" class="mx-3" data-bs-toggle="tooltip"
