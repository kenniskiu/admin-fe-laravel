        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header pb-0">
                    <div class="d-lg-flex">
                        <div>
                            <h5 class="mb-0">Add Assignments</h5>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form action="/assignment-store" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="container">
                            <div class="row">
                                <div class="col">
                        ...
                        <div class="form-group container">
                            <label>Content</label>
                            <textarea name='content' class="form-control"  placeholder="Content" type="" style="height: 100px"></textarea>
                        </div>
                        <a href="/assignment" type="button" class="btn btn-outline-primary btn-sm mb-0">
                            Back
                        </a>
