...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Session</li>
        </ol>
        <h6 class="font-weight-bolder mb-0">Session</h6>
    </nav>
                    ...
                    <div class="d-lg-flex">
                        ...
                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                            <div class="ms-auto my-auto">
                                <a href="/session-create" class="btn bg-gradient-primary btn-sm mb-0">+&nbsp;
                                    New session
                                </a>
                            </div>
                        </div>
                    ...
                    <table class="table table-flus datatable-basic">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Subject ID
                                </th>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Is Sync
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-sm col-lg-2">
                                    <a href="/session-edit/{{ $x->id }}" class="mx-3" data-bs-toggle="tooltip"
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        window.location = "/session-destroy/" + id + "";
