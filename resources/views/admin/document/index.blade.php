...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Document</li>
        </ol>
        <h6 class="font-weight-bolder mb-0">Document</h6>
    </nav>
                    ...
                    <div class="d-lg-flex">
                        ...
                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                            <div class="ms-auto my-auto">
                                <a href="/document-create" class="btn bg-gradient-primary btn-sm mb-0">+&nbsp;
                                    New Document
                                </a>
                            </div>
                        </div>
                    ...
                    <table class="table table-flus datatable-basic">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">File name
                                </th>
                            ...
                            @foreach ($data as $x)
                                <tr>
                                    ...
                                    <td class="text-sm col-lg-2">
                                        <a href="/document-edit/{{ $x->id }}" class="mx-3" data-bs-toggle="tooltip"
                                            data-bs-original-title="Edit">
                                            <i class="fas fa-user-edit text-secondary" aria-hidden="true"></i>
                                        </a>
                                        <a href="#" class="delete-document" data-id="{{ $x->id }}"
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        window.location = "/document-destroy/" + id + "";
