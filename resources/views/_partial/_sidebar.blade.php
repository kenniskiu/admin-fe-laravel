<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="/dashboard-admin">
            <img src="{{ asset('assets/img/kgLogo.png') }}" class="navbar-brand-img h-100" alt="main_logo">
            {{-- <span class="ms-1 font-weight-bold">Kampus Gratis</span> --}}
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto h-auto h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a href="/dashboard-admin" class="nav-link active" aria-controls="dashboardsExamples" role="button"
                    aria-expanded="false">
                    <div
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#pagesExamples1" class="nav-link " aria-controls="pagesExamples"
                    role="button" aria-expanded="false">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                ...
                <div class="collapse " id="pagesExamples1">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            <a class="nav-link " href="/majors">
                                <span class="sidenav-mini-icon"> M </span>
                                <span class="sidenav-normal">Majors</span>
                            </a>
                        </li>
                        <li class="nav-item ">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#pagesExamples2" class="nav-link " aria-controls="pagesExamples"
                    role="button" aria-expanded="false">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                    ...
                    <span class="nav-link-text ms-1">Junction Tables</span>
                </a>
